function [dat] = extract_vaccine_data_0814_2021b(path_)
close all;
home;
cd(path_);
...
%we will create a 3D matrix for the windowed data with dimensions:
...
%compared to manufacturer data (i.e., the span is larger)
